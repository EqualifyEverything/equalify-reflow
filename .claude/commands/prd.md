...
### Read PRD File
1. Locate PRD file in `ai-docs/PRDs/phase-X-*/PRD-{NUMBER}*.md`
...
1. Check if dependency PRD is marked complete in `ai-docs/PRDs/README.md`
...
Updated: ai-docs/PRDs/README.md
```
