...
- subagent to report back how the codebase works, specifically how the AI processing steps work

## Report

Report your understanding of the AI Processing and Prompting Best Practices

## Documentation

### Links to view with webfetch
...
Give Claude a role (system prompts) - https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/system-prompts
