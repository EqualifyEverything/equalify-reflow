...
import { CheckCircle2, SkipForward, AlertCircle, Loader2, Download } from 'lucide-react';
...
export function StepTabs({ steps, activeIndex, onSelect, processingStepName, onDownloadVersion }: StepTabsProps) {
  return (
