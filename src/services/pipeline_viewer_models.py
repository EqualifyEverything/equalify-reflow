...
class FormFieldType(str, Enum):
    ...
    CHECKBOX = "checkbox"
    """A single standalone checkbox (e.g. "I agree to the terms")."""
...
class FormFieldInfo(BaseModel):
    ...
    label: str
    """Accessible label for the field, as read from the image (e.g. "Full name").
    ...
    "Name: ____________" or "☐ I agree"). The injector replaces this text
