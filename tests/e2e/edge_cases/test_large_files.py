...
class TestLargeFileHandling:
    ...
    @pytest.mark.slow
    @pytest.mark.asyncio
    async def test_90mb_pdf_accepted(self, storage_service, mock_s3_client, mocker):
    ...
    @pytest.mark.slow
    @pytest.mark.asyncio
    async def test_100mb_pdf_accepted(self, storage_service, mock_s3_client, mocker):
    ...
    @pytest.mark.slow
    @pytest.mark.asyncio
    async def test_101mb_pdf_rejected(self, storage_service, mocker):
    ...
    @pytest.mark.asyncio
    async def test_large_file_read_chunks(self, storage_service, mock_s3_client, mocker):
